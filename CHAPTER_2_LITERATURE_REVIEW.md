...
**Accent and language mismatch** causes accuracy problems. Commercial voice recognition systems are mainly trained on North American and British English data. Studies have found around 30% accuracy loss when processing non-native English accents, which is a significant problem in Sri Lanka where both guests and hotel staff often speak with a South Asian English accent.
